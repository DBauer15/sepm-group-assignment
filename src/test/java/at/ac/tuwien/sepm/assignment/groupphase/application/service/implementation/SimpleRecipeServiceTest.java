...
public class SimpleRecipeServiceTest extends BaseTest {
	...
	public void testCreate_invalidDataWithInvalidIngredientData_notCallsPersistenceCreateAndValidations()
		...
		try {
			...
			Assert.assertEquals("Enter at least 1 characters in the field 'Ingredient Name'", errors.get(0));
			Assert.assertEquals("Enter a value that is greater than 0.0 in the field 'Unit gram of ingredient '", errors.get(1));
			Assert.assertEquals("Enter a value that is greater than 0.0 in the field 'Amount of ingredient '", errors.get(2));
			...
			Assert.assertEquals("Enter at least 1 characters in the field 'Unit name of ingredient Ice cube'", errors.get(8));
			Assert.assertEquals("Enter a value that is greater than 0.0 in the field 'Amount of ingredient Ice cube'", errors.get(9));
